...
export const schematics: Schematic[] = [
  ...
  },
  {
    ...
    artist: "VendettaMachine",
    image_url: "/onsite/eggplant-method-1.png",
    description: "A hyper-realistic canvas of a man in shadow clutching a glowing eggplant, illuminating the desperate, commerce of male hope.",
    price: 22.30,
